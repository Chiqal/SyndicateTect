...
kk.login(token="EoZPBK6A67O87xayhXi9.fbMcAjl5m9eOdy9zPiwPkq.Ssr6v/x5nOL/l4s04ZR0/z/OnDXZyeR+pqG1vchJx0Q=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="EoZi9zbDl4RJzH7HI2S4.MkwRahR9ZiUNsJo3ElXL9a.zaxMgfA7mhrrCAV8Iu0AHQBqxxr4S7TikS9HbOmVVVU=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EoYfqupJnAAaIhvDURG0.lhi7kD0Il/p2V3aWteDIma.yEjO++mc02qApY9uzR2tG9WNDl/w6yzeaqFPMiHBpI4=")
ks.loginResult()
...
helpMessage ="""S̸͟͞Y̸͟͞N̸͟͞D̸͟͞I̸͟͞C̸͟͞A̸͟͞T̸͟͞E̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞
Owner : A⃜ C⃜h⃜i⃜q⃜a⃜L⃜ F⃜V⃜
▬▬▬▬▬▬▬▬▬▬▬▬
◄]·♦·Menu For Public·♦·[►
╄Help
╄Me
...
mid = cl.getProfile().mid #Jack
Amid = ki.getProfile().mid #Queen
Bmid = kk.getProfile().mid #King
Cmid = kc.getProfile().mid #As
Dmid = ks.getProfile().mid #POker
...
≫ S⃟Y⃟N⃟D⃟I⃟C⃟A⃟T⃟E⃟ B⃟O⃟T⃟ P⃟R⃟O⃟T⃟E⃟C⃟T⃟≪

Owner: c̲̅h̲̅i̲̅q̲̅a̲̅l̲̅ a̲̅d̲̅i̲̅k̲̅s̲̅a̲̅

≫ S̸͟͞M̸͟͞U̸͟͞L̸͟͞E̸͟͞ I̸͟͞N̸͟͞D̸͟͞O̸͟͞N̸͟͞E̸͟͞S̸͟͞I̸͟͞A̸͟͞ F̸͟͞A̸͟͞M̸͟͞I̸͟͞L̸͟͞Y̸͟͞≪
≫ SelfBot ≪
...
def bot(op):
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "||Admin S⃟Y⃟N⃟D⃟I⃟C⃟A⃟T⃟E⃟ P⃟R⃟O⃟T⃟E⃟C⃟T⃟||\n=====================\n"
                  for mi_d in admin:
              ...
              if msg.from_ in admin:
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 300:
                        ...
                        cl.sendText(msg.to, "Kelebihan batas :v")
    #-----------------=Selesai=------------------
            elif msg.text in ["Syn"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              cl.sendText(msg.to, "prσgrєѕѕ chєckíng ѕídєr..")
              try:
              ...
              #print wait2
                  ...
                  if msg.to in wait2['readPoint']:
                      ...
                      cl.sendText(msg.to, "⤵️SIDERS KAMVRET⤵️%s\n||By : 🕸S̸͟͞Y̸͟͞N̸͟͞D̸͟͞I̸͟͞C̸͟͞A̸͟͞T̸͟͞E̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞🕸||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                  else:
                      cl.sendText(msg.to, "Ketik Sider dulu Jablay\nBaru Ketik Read\nDASAR PIKUN ♪")
#-----------------------------------------------
...
#-----------------------------------------------
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye op","Alloff","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
  ...
  #-----------------End-----------
                ...
                cl.sendText(msg.to,"❎KEYWOARD FAILLED❎")
                cl.sendText(msg.to,"❎FAILLED❎")
                cl.sendText(msg.to,"Ketik Sider Lalu Read Untuk Cek Sisipiti kampret")

#-----------------------------------------------
            elif msg.text in ["Say cctv"]:
                cl.sendText(msg.to,"CCTV pekok lu kerjaan cuma read")
                ki.sendText(msg.to,"Turun Lu")
                kk.sendText(msg.to,"Gua doain Kurapan,\nPanuan\nBintitan\Bisulan\Amiiin Ya Allah.")
            elif msg.text in ["Say Pagi"]:
                ki.sendText(msg.to,"Pagiiii Famz 😘")
                kk.sendText(msg.to,"Morniiing Semuanya 😘")
                kc.sendText(msg.to,"Morniiing Semuanya 😘")
            ...
            elif msg.text in ["Say giri"]:
                cl.sendText(msg.to,"gιrι ιтυ jaвlay")
                cl.sendText(msg.to,"jaвlay ιтυ gιrι")
                cl.sendText(msg.to,"ϖƘϖƘƘϖϖƘƘϖϖƘƘ")
            elif msg.text in ["#welcome"]:
                cl.sendText(msg.to,"Selamat datang di Group Kami")
                cl.sendText(msg.to,"Jangan nakal ok!")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping"]:
                cl.sendText(msg.to,"jαngαn mєчαkínkαn dírí вαhwα dчα mєnчukαímu hαnчα kαrnα dчα вєrѕíkαp mαníѕ kєpαdαmu, kαrєnα kαdαng kαmu hαnчαlαh ѕєвuαh pílíhαn kєtíkα dчα вσѕαn.")
                cl.sendText(msg.to,"աƘաƘաƘաƘաƘաƘ")
                cl.sendText(msg.to,"😭😭😭😭😭")
#-----------------------------------------------

       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Absen bot","Absen dulu","Respons"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"rϵαδϒ ϴͷ✔️")
                ki.sendText(msg.to,"rϵαδϒ ϴͷ✔️")
                kk.sendText(msg.to,"rϵαδϒ ϴͷ✔️")
                kc.sendText(msg.to,"rϵαδϒ ϴͷ✔️")
                ks.sendText(msg.to,"rϵαδϒ ϴͷ✔️")
                cl.sendText(msg.to,"Yang Penting Josssss")
      #-------------Fungsi Respon Finish---------------------#
                            

      #-------------Fungsi Balesan Respon Start---------------------#
            elif msg.text in ["Ini Apa","ini apa","Apaan Ini","apaan ini"]:
                ki.sendText(msg.to,"ϒα gῖtῠ δαh ϼϴkϴkͷϒα ϻαh")
      ...
      #-------------Fungsi Banned Send Contact Start------------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"ѕєnd cσntαct")
                ki.sendText(msg.to,"ѕєnd cσntαct")
                kk.sendText(msg.to,"ѕєnd cσntαct")
                kc.sendText(msg.to,"ѕєnd cσntαct")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"ítu crєαtσr kαmí чg pαlíng tαmpαn rupαwαn.. 😜")
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'uab9e9a4220733668859368b2a68285fb'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Udah gitu aja")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Siapa aku"]:
                 quote = ['Orang','Gembel\nMalaikat','Jablay','Bidadari tanpa sayap','Setan','Bot yqng baik hati','Siluman','Lu siapa ?','Pemulung','Gembel naik kelas','Calon Penghuni neraka','Istri yg solehah','Tukang sange','Penghuni Syurga','Tukang ngibul','Tukang jamu','tukang modus','Manusia aneh']
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        ...
                        random.choice(KAC).kickoutFromGroup(msg.to,[jj])
                        random.choice(KAC).kickoutFromGroup(msg.to,[jj])
                    random.choice(KAC).sendText(msg.to,"Blacklist sanaa")
                    random.choice(KAC).sendText(msg.to,"Blacklist sanaa")
                    random.choice(KAC).sendText(msg.to,"Blacklist sanaa")
                    random.choice(KAC).sendText(msg.to,"Blacklist sanaa")
...
#---------------------
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "ѕєℓαмαт ∂αтαиg ∂ι gяυρ  " + str(ginfo.name))
          random.choice(KAC).sendText(op.param1, "fσυи∂єя gяσυρ " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
          random.choice(KAC).sendText(op.param1,"вυ∂αуαкαи вα¢α иσтє уα кαк\nSemoga Betah Kk 😘")
    ...
    for zx in range(0,50):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by c̲̅h̲̅i̲̅q̲̅a̲̅l̲̅ a̲̅d̲̅i̲̅k̲̅s̲̅a̲̅\n S̸͟͞M̸͟͞U̸͟͞L̸͟͞E̸͟͞ I̸͟͞N̸͟͞D̸͟͞O̸͟͞N̸͟͞E̸͟͞S̸͟͞I̸͟͞A̸͟͞ F̸͟͞A̸͟͞M̸͟͞I̸͟͞L̸͟͞Y̸͟͞")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^🕸S⃟Y⃟N⃟D⃟I⃟C⃟A⃟T⃟E⃟ P⃟R⃟O⃟T⃟E⃟C⃟T⃟🕸^\nStatus Boss udah Kami Like\nOwner Kami :\nChiqal Adiksa")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"LIKE BACK")
                    print "Like"
                except:
                    pass
            else:
